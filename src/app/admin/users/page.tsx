              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/50 text-xs font-mono mt-1">{user.matric || "—"}</p>
                    </div>
                  </div>
                  ...
                  <div className="text-right">
                    <div className={`px-3 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 mb-2 ${
                      ...
                      {user.role === "seller" ? <ShieldCheck className="w-4 h-4" /> : <User className="w-4 h-4" />}
                      {user.role.toUpperCase()}
                    </div>
                    <p className="text-white/60 text-xs">Joined {user.joined}</p>
                  </div>
                </div>
                ...
                {user.role === "seller" && (
                  <div className="mt-4 pt-4 border-t border-white/10 flex justify-between text-sm">
                    ...
                    <span className="text-emerald-400 font-bold">{user.orders}</span>
                  </div>
                )}
              </motion.div>
            ))
