      ...
      <div className="p-4 pb-24">
        ...
        <div className="grid grid-cols-2 gap-4">
          {filteredProducts.map((p) => (
            <div
              key={p.id}
              className="bg-surface rounded-xl overflow-hidden hover:shadow-lg transition-all cursor-pointer relative group"
            >
              ...
              <button className="absolute top-2 right-2 p-1.5 bg-white rounded-full shadow opacity-0 group-hover:opacity-100 transition-opacity">
