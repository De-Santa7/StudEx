...
export default function WalletHistoryPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      // Demo transactions for empty state
      setTransactions([
        {
          id: "1",
          type: "credit",
      ...
      <div className="p-4 pb-24 max-w-3xl mx-auto space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <p className="text-2xl font-black">₦{totalCredit.toLocaleString()}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-2xl font-black">₦{totalDebit.toLocaleString()}</p>
          </motion.div>
        </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-600 mt-1">{formatDate(transaction.date)}</p>
