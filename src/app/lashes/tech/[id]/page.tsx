// src/app/lashes/tech/[id]/page.tsx
"use client";
...
const techData: Record<string, any> = {
  "1": { name: "Lash Queen Bella", rating: 4.9, location: "Moremi Hall", img: "lashes-vendor-1.jpg", styles: 18 },
  "2": { name: "Flutter Studio", rating: 4.8, location: "Angola Hall", img: "lashes-vendor-2.jpg", styles: 22 },
  "3": { name: "Lash Bae OAU", rating: 4.7, location: "Fajuyi Hall", img: "lashes-vendor-3.jpg", styles: 15 },
  "4": { name: "Volume Vault", rating: 4.8, location: "Postgraduate Hall", img: "lashes-vendor-4.jpg", styles: 20 },
};

const styles = [
  { id: 1, title: "Classic Lashes", price: 5000, img: "classic-lashes.jpg", rating: 4.9 },
  { id: 2, title: "Volume Lashes", price: 8000, img: "volume-lashes.jpg", rating: 4.8 },
  { id: 3, title: "Hybrid Lashes", price: 6500, img: "hybrid-lashes.jpg", rating: 4.7 },
  { id: 4, title: "Lash Lift + Tint", price: 4500, img: "lash-lift.jpg", rating: 4.9 },
  { id: 5, title: "Wispy Lashes", price: 7500, img: "wispy-lashes.jpg", rating: 4.9 },
  { id: 6, title: "Mega Volume", price: 9500, img: "mega-volume.jpg", rating: 5.0 },
];

export default function LashTechMenu() {
      ...
      <motion.div initial={{ y: -20 }} animate={{ y: 0 }} className="sticky top-0 bg-white/80 backdrop-blur-xl z-40 border-b">
        ...
        <div className="px-4 pb-4">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search lash styles..."
              value={search}
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-2 text-sm">
              ...
              <span className="text-gray-600">{tech.styles} styles</span>
            </div>
          </div>
        </motion.div>
        ...
        <div className="space-y-4">
          {filtered.map((style) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => router.push(`/lashes/${style.id}`)}
